...
#python ./src/main.py --mode super-resolution --model GCSR --scale 2 --patch_size 96 --save edsr_baseline_x2 --reset
...
#python ./src/main.py --mode super-resolution --model GCSR --scale 4 --save gcsr_x4 --n_resblocks 32 --n_feats 256 --res_scale 0.1 --reset --save_results
...
#python ./src/main.py --mode super-resolution --scale 4 --pre_train ./experiment/gcsr_x4/model/model_best.pt --test_only --save_results
...
#python ./src/main.py --mode super-resolution --template RCAN --save RCAN_BIX4_G10R20P48 --scale 4 --reset --save_results --patch_size 192 #--pre_train ../experiment/model/RCAN_BIX2.pt
...
#python ./src/main.py --mode super-resolution --save_results